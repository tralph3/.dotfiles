...
(setq zettlekasten-paths-alist '(("Main" . "~/Documents/wiki/")
...
(use-package org-roam
  :ensure t
  :custom
  (org-roam-directory (cdr (assoc-string "Main" zettlekasten-paths-alist)))
  (org-roam-db-location (concat (cdr (assoc-string "Main" zettlekasten-paths-alist)) "org-roam.db"))
  :bind
  (("C-c n f" . org-roam-node-find)
   ("C-c n s" . switch-zettlekasten)
   (:map org-mode-map
