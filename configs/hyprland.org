...
#+begin_src conf :tangle ~/.config/hypr/hyprland.conf
  ...
  bind=SUPERCONTROL,LEFT,resizeactive,-80 0
  bind=SUPERCONTROL,J,resizeactive,0 80
  bind=SUPERCONTROL,DOWN,resizeactive,0 80
  bind=SUPERCONTROL,K,resizeactive,0 -80
  bind=SUPERCONTROL,UP,resizeactive,0 -80
  bind=SUPERCONTROL,L,resizeactive,80 0
  bind=SUPERCONTROL,RIGHT,resizeactive,80 0
